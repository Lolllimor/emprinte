...
export function Footer() {
  return (
    <footer className="w-full bg-white px-4 py-9 xl:px-[120px] lg:px-[64px] md:px-[32px] flex flex-col items-start gap-2.5">
          ...
          <div className="flex items-start gap-[64px]">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="inline-flex flex-col justify-center items-start gap-6">
                <a href="https://instagram.com/emprinte" aria-label="Instagram">
